...
public class EquipmentHome {
	...
	public Equipment merge(Equipment detachedInstance) {
		...
		try {
			Equipment result = (Equipment) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Equipment findById(int id) {
		...
		try {
			Equipment instance = (Equipment) sessionFactory.getCurrentSession().get("com.nari.opfive.domain.Equipment",
					id);
			if (instance == null) {
	...
	public List<Equipment> findByExample(Equipment instance) {
		...
		try {
			List<Equipment> results = (List<Equipment>) sessionFactory.getCurrentSession()
					.createCriteria("com.nari.opfive.domain.Equipment").add(create(instance)).list();
